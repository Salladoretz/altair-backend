/*
  ...
  - You are about to drop the column `bossGenitive` on the `Partner` table. All the data in the column will be lost.

*/
-- AlterTable
ALTER TABLE "Contract" ADD COLUMN "contractAmount" INTEGER;
ALTER TABLE "Contract" ADD COLUMN "contractPeriod" DATETIME;
