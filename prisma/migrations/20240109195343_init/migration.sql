/*
  ...
  - You are about to alter the column `ogrnDate` on the `Partner` table. The data in that column could be lost. The data in that column will be cast from `String` to `DateTime`.
